    ...
    <nav class="navbar navbar-expand-lg ">
        ...
        <div class="container-fluid ">
            ...
            <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                <!-- Expand-->
                <li class="nav-item d-flex align-items-center full_scr_exp"><a class="nav-link" href="#"><img src="{{asset('admin/img/expand.png')}}" onclick="toggleFullScreen(document.body)" class="img-fluid" alt=""></a></li>
                <!-- Search-->
                ...
                <li class="nav-item dropdown"><a id="profile" class="nav-link logout" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{asset('admin/img/avatar-1.jpg')}}" alt="..." class="img-fluid rounded-circle" style="height: 30px; width: 30px;"></a>
                                        ...
                                        <ul class="list-unstyled">
                                            <li class="border border-primary">
                                                <a rel="nofollow " href="#" class=" d-flex">
                                                    <div class="news-f-img"> <img src="{{asset('admin/img/avatar-2.jpg')}}" alt="..." class="img-fluid rounded-circle"></div>
                                                    <div class="msg-body">
                                            ...
                                            <li class="border border-success">
                                                <a rel="nofollow" href="#" class=" d-flex">
                                                    <div class="news-f-img"> <img src="{{asset('admin/img/avatar-3.jpg')}}" alt="..." class="img-fluid rounded-circle"></div>
                                                    <div class="msg-body">
                                            ...
                                            <li class="border border-info">
                                                <a rel="nofollow" href="#" class=" d-flex">
                                                    <div class="news-f-img"> <img src="{{asset('admin/img/avatar-4.jpg')}}" alt="..." class="img-fluid rounded-circle"></div>
                                                    <div class="msg-body">
                                            ...
                                            <li class="border border-primary">
                                                <a rel="nofollow" href="#" class=" d-flex">
                                                    <div class="news-f-img"> <img src="{{asset('admin/img/avatar-1.jpg')}}" alt="..." class="img-fluid rounded-circle"></div>
                                                    <div class="msg-body">
                                                        <h6 class="h5 msg-nav-h6">Low cost Modern printer</h6>
                                                        <small>A dot matrix printer modified at...</small>
                                                    </div>
...
<div class="page-content d-flex align-items-stretch">
    ...
    <nav class="side-navbar">
        ...
        <ul class="list-unstyled">
            ...
            <li><a href="{{route('admin.category_list')}}" > <i class="fa fa-file-o"></i>分类管理 </a>
        ...
        <div class="row" id="report4">
            <div class="col-md-4" id="card-1">
                <div class="card card-inverse card-info">
                    <img class="card-img-top" src="{{asset('admin/img/card/c-1.jpg')}}">
                    <div class="card-block">
            ...
            <div class="col-md-4 mt-0" id="card-2">
                <div class="card hovercard">
                    ...
                    <div class="avatar">
                        <img alt="" src="{{asset('admin/img/avatar-1.jpg')}}" class="img-fluid">
                    </div>
                    <div class="info">
                        <div class="title">
